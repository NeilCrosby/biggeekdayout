...
<html lang="en">
    <head>
        ...
        <title>Big Geek Day Out - An unEvent for Geeks</title>
...
/*            .vevent .description {
            ...
            #add-on-upcoming:focus,
            #add-on-upcoming:active,
            #add-on-upcoming:hover {
                background: red;
            }
            
            #add-on-upcoming span {
                font-size: 50%;
                font-weight: normal;
                display: block;
                background: ;
